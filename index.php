  ...
  <div class="index-section-1-copy">
    ...
    <div class="index-section-1-copy-container">
      <p class="index-section-1-text">
        <b>EFM Capital se especializa </b>en invertir en empresas que operan bajo un <b>modelo de gestión familiar</b> y requieren mejoras en su <b>modelo de negocio.</b> Logramos que la empresa opere en un  <b>marco institucional</b> que facilite la captación de nuevos inversionistas.
      </p>
      <p class="index-section-1-text">
           El objetivo es lograr, <b>en el corto plazo, </b>una <b>venta o asociación estratégica </b>con los principales <b>corporativos e independientes.</b>
      </p>
    </div>
    <hr class="index-section-hr"/>
  </div>
  ...
  <div class="index-section-3-content">
    <div class="index-section-3-header">
      <hr class="index-section-3-slide-hr">
        <span class="index-section-3-heading">Fondo puente</span>
      <hr class="index-section-3-slide-hr">
    </div>
...
<section class="index-section-6">
  <div class="index-section-6-header">
    <hr class="index-section-6-slide-hr">
      <span class="index-section-6-heading">Miembros de</span>
    <hr class="index-section-6-slide-hr">
  </div>
...
<section class="index-section-7">
  <div class="index-section-7-content">
    <div class="index-section-7-a">
      ...
      <span class="index-section-7-text">Horario: Lunes a Viernes, 8:00AM a 6:00PM (Tiempo del centro de México)</span>
    </div>
    <div class="index-section-7-b">
      <span class="index-section-7-text"><b>Contacto para banqueros, fondos de inversión y clientes registrados:</b></span>
