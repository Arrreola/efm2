    ...
    <div class="operaciones-section-1-text-box">
        <?php if ($len == 'es'): ?>
            ...
            <p class="operaciones-section-1-text">
                ...
                CAPITAL, S.A. de C.V., y por ningún motivo será transferida o compartida a terceros salvo lo previsto
                bajo la ley aplicable.
            </p>
            <p class="operaciones-section-1-text">
                Si el titular de los datos personales desea limitar de cualquier forma el uso de los mismos, puede
                enviar un correo electrónico a privacidad@efmcapital.com, o bien, puede dirigirse por escrito con acuse
            ...
            <p class="operaciones-section-1-text">
                ...
                Se recomienda al titular de los datos personales que visite regularmente este sitio para actualizarse en
        ...
        <form enctype="multipart/form-data" name="pagerform" id="formMelbourne">
            ...
            <div class="row-4">
                ...
                <input class="operaciones-form-button" type="button" name="enviar" id="enviar"
                       value="<?php if ($len == 'es'): ?>Ver ficha técnica<?php else: ?>See data sheet<?php endif; ?>" onclick="validateForm('formMelbourne')">
            </div>
        </form>
    </div>
</section>
