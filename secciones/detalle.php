    ...
    <section class="wn-section-1">
        ...
        <div class="wn-nt-include-module">
            ...
            <ul class="wn-nt-social-list">
                ...
                <li class="wn-nt-social-icon google"><a href="#"><i class="icon-google socicon-google"></i></a></li>
                <li class="wn-nt-social-icon linked"><a href="#"><i class="icon-linked socicon-linkedin"></i></a></li>
            </ul>
        </div>
