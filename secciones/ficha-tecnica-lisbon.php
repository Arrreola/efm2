    ...
    <div class="ficha-tecnica-content">
        ...
        <div class="operaciones-section-1-form">
            <div class="operaciones-side-b-1">
                ...
                <a href="descarga/lisbon-<?= $len; ?>.pdf" target="_blank"><button class="operaciones-side-b-button-descarga">Descargar</button></a>
                <hr>
                ...
                <p class="operaciones-side-b-text-1">
                    EFM Capital se reserva la decisión sobre las autorizaciones de acceso a la plataforma, conforme a sus propios criterios institucionales y no garantiza el envío del convenio de confidencialidad.
                </p>
            </div>
